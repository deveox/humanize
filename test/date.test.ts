...
describe('formatDate', () => {
  ...
  it('should return proper value for different formats', () => {
    ...
    expect(formatDate('1995-12-17', 'date')).toEqual('17/12/1995')
    expect(formatDate('Sun Dec 17 1995', 'date')).toEqual('17/12/1995')
    expect(formatDate(1659965673, 'date')).toEqual('08/08/2022')
    expect(formatDate('1995-12-17', 'date-period')).toEqual('17/12/1995 (27 years ago)')
    expect(formatDate('1995-12-17T03:24:00', 'time-period')).toEqual('17/12/1995 03:24:00 (27 years ago)')
    expect(formatDate('1995-12-17', 'day')).toEqual('Dec 17')
    expect(formatDate('1995-12-17T03:24:00', 'min')).toEqual('17/12/1995 03:24')
